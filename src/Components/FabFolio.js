        ...
        <div className="flip-card">
            <div className="flip-card-inner">
              <div className="flip-card-front">
                <img className="imgcard" src="https://keep.google.com/u/0/media/v2/1IF7wCjnJCVH9HFrXUbazHMHrd2Q6xPIY5sjaKF8Y_iMxrYF0gZKzvxCpEoua3g/1DJcI9P8ibu0pU6wml8vaOqGlrVitATw5xeKp3DCyUbmz7eGOVeGjV3l-oLaI?accept=image/gif,image/jpeg,image/jpg,image/png,image/webp,audio/aac&sz=1441" alt="Avatar"  />
              </div>
